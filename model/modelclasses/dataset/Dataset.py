...
from model.modelclasses.Vocabulary import *
from model.modelclasses.Utils import *
from model.modelclasses.model.Config import *
...
class Dataset:
    ...
    def save_metadata(self, path):
        np.save("{}/meta_dataset".format(path), np.array([self.input_shape, self.output_size, self.size], dtype='float16'))
